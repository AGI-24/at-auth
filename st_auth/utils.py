...
from st_auth.auth import mongo_auth as ma
from st_auth.auth import sql_auth as sa
from st_auth.auth import json_auth as ja
from st_auth.auth import yaml_auth as ya
from st_auth.config import MONGO_AUTH, SQL_AUTH, JSON_AUTH, YAML_AUTH
